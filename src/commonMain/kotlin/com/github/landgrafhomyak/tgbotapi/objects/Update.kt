...
sealed class Update {
    ...
    class Message(
        ...
        val message: com.github.landgrafhomyak.tgbotapi.objects.Message
    ) : Update()
    ...
    class EditedMessage(
        ...
        val editedMessage: com.github.landgrafhomyak.tgbotapi.objects.Message
    ) : Update()
    ...
    class ChannelPost(
        ...
        val channelPost: com.github.landgrafhomyak.tgbotapi.objects.ChannelPost
    ) : Update()
    ...
    class EditedChannelPost(
        ...
        val editedChannelPost: com.github.landgrafhomyak.tgbotapi.objects.ChannelPost
    ) : Update()
    ...
    class CallbackQuery(
        ...
        val callbackQuery: com.github.landgrafhomyak.tgbotapi.objects.CallbackQuery
    ) : Update()
    ...
    class PollAnswer(
        ...
        val poll: com.github.landgrafhomyak.tgbotapi.objects.PollAnswer
    ) : Update()
